...
#   set_location_assignment PIN_V2   -to SW17  ;# SW17
   ...
   set_location_assignment PIN_AE22  -to correct_freq ;# LEDG0 (on the right side)
#   set_location_assignment PIN_AF22  -to released ;# LEDG1
...
#   set_location_assignment PIN_AA20  -to LEDG6 ;# LEDG6
   set_location_assignment PIN_Y18   -to success ;# LEDG7
#   set_location_assignment PIN_Y12   -to unlock ;# LEDG8 (between 7-segments)


   ;##################################################
   ;# 18 red LEDs                                    #
   ;# placed above the 18 slide switches on the left #
   ;# Active High - ON when '1                       #
   ;##################################################

   set_location_assignment PIN_AE23  -to failure   ;# LEDR0
...
#   set_location_assignment PIN_AD22  -to count[4]   ;# LEDR4
#   set_location_assignment PIN_AD23  -to count[5]   ;# LEDR5
#   set_location_assignment PIN_AD21  -to count[6]   ;# LEDR6
#   set_location_assignment PIN_AC21  -to count[7]   ;# LEDR7
#   set_location_assignment PIN_AA14  -to count[8]   ;# LEDR8
#   set_location_assignment PIN_Y13   -to count[9]   ;# LEDR9
...
#   set_location_assignment PIN_AF13  -to valid  ;# LEDR14
#   set_location_assignment PIN_AE13  -to is_pressed  ;# LEDR15
#   set_location_assignment PIN_AE12  -to released  ;# LEDR16
#   set_location_assignment PIN_AD12  -to blowup  ;# LEDR17 (on the left side)
...
#   set_location_assignment PIN_AA26 -to ss3[4]   ;# c ss3[4]
#   set_location_assignment PIN_Y26  -to ss3[3]   ;# d ss3[3]
#   set_location_assignment PIN_Y25  -to ss3[2]   ;# e ss3[2]
#   set_location_assignment PIN_U22  -to ss3[1]   ;# f ss3[1]
#   set_location_assignment PIN_W24  -to ss3[0]   ;# g ss3[0]
##
##  ;# the group of 2 seven segments in the middle
##
#   set_location_assignment PIN_U9   -to ss4[6]   ;# a ss4[6]
#   set_location_assignment PIN_U1   -to ss4[5]   ;# b ss4[5]
#   set_location_assignment PIN_U2   -to ss4[4]   ;# c ss4[4]
#   set_location_assignment PIN_T4   -to ss4[3]   ;# d ss4[3]
#   set_location_assignment PIN_R7   -to ss4[2]   ;# e ss4[2]
#   set_location_assignment PIN_R6   -to ss4[1]   ;# f ss4[1]
#   set_location_assignment PIN_T3   -to ss4[0]   ;# g ss4[0]
##
#   set_location_assignment PIN_T2   -to ss5[6]   ;# a ss5[6]
#   set_location_assignment PIN_P6   -to ss5[5]   ;# b ss5[5]
#   set_location_assignment PIN_P7   -to ss5[4]   ;# c ss5[4]
#   set_location_assignment PIN_T9   -to ss5[3]   ;# d ss5[3]
#   set_location_assignment PIN_R5   -to ss5[2]   ;# e ss5[2]
#   set_location_assignment PIN_R4   -to ss5[1]   ;# f ss5[1]
#   set_location_assignment PIN_R3   -to ss5[0]   ;# g ss5[0]
##
##  ;# the group of 2 seven segments on the left
##
#   set_location_assignment PIN_R2   -to ss6[6]   ;# a ss6[6]
#   set_location_assignment PIN_P4   -to ss6[5]   ;# b ss6[5]
#   set_location_assignment PIN_P3   -to ss6[4]   ;# c ss6[4]
#   set_location_assignment PIN_M2   -to ss6[3]   ;# d ss6[3]
#   set_location_assignment PIN_M3   -to ss6[2]   ;# e ss6[2]
#   set_location_assignment PIN_M5   -to ss6[1]   ;# f ss6[1]
#   set_location_assignment PIN_M4   -to ss6[0]   ;# g ss6[0]
##
#   set_location_assignment PIN_L3   -to ss7[6]   ;# a ss7[6]
#   set_location_assignment PIN_L2   -to ss7[5]   ;# b ss7[5]
#   set_location_assignment PIN_L9   -to ss7[4]   ;# c ss7[4]
#   set_location_assignment PIN_L6   -to ss7[3]   ;# d ss7[3]
#   set_location_assignment PIN_L7   -to ss7[2]   ;# e ss7[2]
#   set_location_assignment PIN_P9   -to ss7[1]   ;# f ss7[1]
#   set_location_assignment PIN_N9   -to ss7[0]   ;# g ss7[0]
...
#   set_location_assignment PIN_D8   -to VERT_SYNC
   ;# connect (VGA_CLK) to the colok of sync !
#   set_location_assignment PIN_B8   -to VGA_CLK
   ;# connect (VGA_BLANK) to VCC !
#   set_location_assignment PIN_D6   -to VGA_BLANK
   ;# (VGA_SYNC) seems not to be important ?
...
#   set_location_assignment TD_VS      -to  PIN_K9
   ...
   set_location_assignment PIN_D26 -to kb_clk
   set_location_assignment PIN_C24 -to kb_serial_data
...
#   set_location_assignment PIN_AD25 -to SD_CLK
   ...
   ;###############################################
   ;# Alphanumeric LCD display not including data #
   ;###############################################
   ...
   ;# LCD Power ON/OFF
   set_location_assignment PIN_L4 -to pwr
   ;# LCD Back Light ON/OFF
   set_location_assignment PIN_K2 -to bkpwr
